...
const getApplicantSignatureNameOverlay = (application) => {
  const verifiedIdentitySource = resolveVerifiedIdentitySource(application);
  const applicantName =
    verifiedIdentitySource === "digilocker"
      ? firstNonEmpty(
...
const getApplicantDDPINameOverlay = (application) => {
  const verifiedIdentitySource = resolveVerifiedIdentitySource(application);
  const applicantName =
    verifiedIdentitySource === "digilocker"
      ? firstNonEmpty(
...
const getApplicantNameOverlays = (application) =>
  [
    ...
    getApplicantSignatureNameOverlay(application),
    getApplicantDDPINameOverlay(application),
  ].filter(Boolean);
